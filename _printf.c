...
*
* Description: This function behaves similarly to the standard printf function,
* processing the formatstring and printing the corresponding arguments based on
* the format specifiers. It supports '%c', '%s', '%d', '%i', and '%%'.
*
...
*
* Description: This function checks the format specifier and calls the
* corresponding function to print the argument. If the specifier is not
* recognized, it prints the specifier as it is.
*
